...
if (!isset($_SESSION["categories_edit_error"])){
	...
	$cid = $_GET["cid"];
	$sql = "select * from 0209266_categories_31 where cid=$cid";
...
<html>
	...
	<td><input style="width:180px" type=text value="<?php echo $row["cname"];?>" name=txtCname></td>
				...
				<tr>
					...
					<td>
						<input type="radio" name="rdCstatus" value="1" <?php if ($row["cstatus"] == 1) echo "checked" ?>>Active
						<input type="radio" name="rdCstatus" value="0" <?php if ($row["cstatus"] == 0) echo "checked" ?>>Inactive
					</td>
				</tr>
				<tr>
