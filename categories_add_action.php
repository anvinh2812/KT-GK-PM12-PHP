<?php
	...
	$sql = "select * from 0209266_categories_31 where cname like '$cname'";
	$result = $conn->query($sql);
	if ($result->num_rows>0){
		$_SESSION["categories_add_error"]="$cname adready exist!";
		header("Location:categories_add.php");
	} else {
			$sql ="insert into 0209266_categories_31(cname,cdesc,cimage,corder,cstatus) values ('$cname','$cdesc','$cimage',$corder,$cstatus)";
