<?php 
	...
	$pid = $_GET["pid"]; // Lấy pid từ URL
	$sql = "SELECT * FROM 0209266_product_31 WHERE pid=$pid"; // Truy vấn dữ liệu từ bảng product
	...
	<body>
		...
		<form method=POST action="product_edit_action.php?pid=<?php echo $pid;?>">
			<table border=0 align=center width=400>
				...
				<tr>
					<td>SID:</td>
					<td><input style="width:180px" type=text value="<?php echo $row["sid"];?>" name=txtSid></td>
				</tr>
				<tr>
					<td>Size ID:</td>
					<td><input style="width:180px" type=text value="<?php echo $row["sizeid"];?>" name=txtSizeid></td>
				</tr>
				<tr>
